...
function [imageName, F] = moonViewModuleCalibration(distanceToMoon, illuminationAngle, MoonComp, RComp)
...
hs = geoshow(DarkMoon, baseR, 'FaceColor', whiteColor); %Color flattened
